...
from google_verify.apis import VerifyOAuthTokenApi
...
class TestVerifyOAuthTokenApi(TestCase):
    ...
    @patch.object(id_token, 'verify_oauth2_token', MagicMock(return_value="Surströmming"))
    ...
    def test_api_returns_status_200_when_correct_token(self):
        ...
        self.assertTrue("Just keep swimming" in return_value.data)
